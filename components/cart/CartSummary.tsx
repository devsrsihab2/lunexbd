  ...
  if (!cart?.items?.length) {
    return (
      <section className={styles.emptyCart}>
        ...
        <p>
          Discover Lunex bags, wallets and travel pieces, then come back here
        ...
        <aside className={styles.summary} aria-label="Cart totals">
          ...
          <dl>
            ...
            {cart.totals.discount ? (
              <div>
                <dt>Discount</dt>
                <dd>-{formatPrice(cart.totals.discount)}</dd>
              </div>
            ) : null}
            <div>
              <dt>Shipping</dt>
              <dd>{formatPrice(cart.totals.shipping || 0)}</dd>
            </div>
            <div>
              <dt>Tax</dt>
              <dd>{formatPrice(cart.totals.tax || 0)}</dd>
            </div>
          ...
          <Link className={styles.checkout} href={checkoutHref}>
            Proceed to Checkout
          </Link>
        </aside>
      </div>
